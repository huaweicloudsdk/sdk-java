...
public class StatisticServiceTest extends AbstractTest {
	...
	public void testQueryTotalNetworkTraffic() throws IOException, InterruptedException {
		...
		Flux flux = osv3().cdn().statistics().queryTotalNetworkTraffic("www.huawei.com", queryDate, queryDate);
	...
	public void testQueryDetailsOfNetworkTraffic() throws IOException, InterruptedException {
		...
		FluxDetail fluxDetail = osv3().cdn().statistics().queryDetailsOfNetworkTraffic("www.huawei.com");
		RecordedRequest request = server.takeRequest();
	...
	public void testQueryPeakBandwidth() throws IOException, InterruptedException {
		...
		Bandwidth bandwidth = osv3().cdn().statistics().queryPeakBandwidth("www.huawei.com");
		RecordedRequest request = server.takeRequest();
	...
	public void testQueryDetailsOfNetworkBandwidth() throws IOException, InterruptedException {
		...
		BandwidthDetail bandwidthDetail = osv3().cdn().statistics().queryDetailsOfNetworkBandwidth("www.huawei.com");
		RecordedRequest request = server.takeRequest();
	...
	public void testQueryConsumptionSummary() throws IOException, InterruptedException {
		...
		DomainSummary domainSummary = osv3().cdn().statistics().queryConsumptionSummary("www.huawei.com", "flux_hit_rate");
		RecordedRequest request = server.takeRequest();
	...
	public void testQueryConsumptionSummaryDetails() throws IOException, InterruptedException {
		...
		DomainSummaryDetail domainSummaryDetail = osv3().cdn().statistics().queryConsumptionSummaryDetails("www.huawei.com", "bs_flux");
		RecordedRequest request = server.takeRequest();
	...
	public void testQueryDomainConsumptions() throws IOException, InterruptedException {
		...
		List<DomainConsumption> domainConsumptions = osv3().cdn().statistics().queryDomainConsumptions("s4.donyd.com", "flux");
		RecordedRequest request = server.takeRequest();
