...
@Test(suiteName = "Database/Version/Test")
public class DatabaseServiceVersionTest extends AbstractTest {

	private static final Logger logger = LoggerFactory.getLogger(DatabaseServiceVersionTest.class);
