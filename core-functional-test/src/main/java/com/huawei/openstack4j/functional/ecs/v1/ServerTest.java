...
///*******************************************************************************
// *******************************************************************************/
//package com.huawei.openstack4j.functional.ecs.v1;
//
...
//				.count(2).build();
//		String jobId = osclient.ecs().servers().create(creation);
//		
...
//		String jobId = osclient.ecs().servers().delete(collect, true, true);
